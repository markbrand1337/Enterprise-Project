...
--
-- Host: 127.0.0.1:4406
-- Generation Time: Apr 30, 2020 at 05:17 PM
...
INSERT INTO `tblclassroom` (`classroom_id`, `name`, `tutor_id`, `note`) VALUES(5, 'Human Resource', 12, 'For HR major');
...
INSERT INTO `tblconversation` (`conversation_id`, `user_one`, `user_two`) VALUES(18, 2, 26);
INSERT INTO `tblconversation` (`conversation_id`, `user_one`, `user_two`) VALUES(19, 5, 26);
...
INSERT INTO `tblmeeting` (`id`, `meeting_date`, `classroom_id`, `note`, `start_at`, `end_at`) VALUES(8, '2020-03-31', 1, 'New Meeting', NULL, NULL);
...
INSERT INTO `tblmeetingmessage` (`message_id`, `id`, `content`, `send_at`, `from_id`) VALUES(2, 1, 'Hey staff', '2020-04-27 11:38:39', 5);
INSERT INTO `tblmeetingmessage` (`message_id`, `id`, `content`, `send_at`, `from_id`) VALUES(3, 1, 'Hey i want to join the meeting', '2020-04-27 17:50:11', 11);
...
INSERT INTO `tblmessage` (`message_id`, `conversation_id`, `content`, `send_at`, `from_id`, `to_id`) VALUES(33, 18, 'sup', '2020-04-29 00:54:13', 2, 26);
...
INSERT INTO `tblpost` (`post_id`, `content`, `user_id`, `in_class`, `created_at`) VALUES(18, 'Hello, i made a post', 11, 0, '2020-04-27 17:46:05');
...
INSERT INTO `tbluserlog` (`last_activity_at`, `user_id`) VALUES('2020-04-29 00:54:13', 2);
INSERT INTO `tbluserlog` (`last_activity_at`, `user_id`) VALUES('2020-04-29 01:01:29', 5);
...
INSERT INTO `tbluserlog` (`last_activity_at`, `user_id`) VALUES('2020-04-27 17:50:11', 11);
...
--
ALTER TABLE `tblconversation`
  MODIFY `conversation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
